...
5. **Do not restyle `diy_realities.html` as the index solar system or the green Pure Systems terminal.** The route is a magenta/amber hyperspace loom; copy is still a placeholder title only.
